...
const AboutView: React.FC = () => {
  return (
    <div className='container flex flex-col items-center justify-center mx-auto mt-10 space-y-10 '>
      <div className='flex flex-col p-10 space-y-5 w-[86.25rem] border-[1px] border-solid border-[#4848A4] rounded-xl'>
        <div className='text-6xl font-bold text-[#4848A4]'>Về chúng mình</div>
        <div className='flex flex-col p-10 space-y-5'>
          <div className='flex flex-row text-[32px] items-center'>
          ...
          <div className='flex flex-row text-[32px] justify-between items-center'>
      ...
      <div className='flex flex-col p-10 space-y-5 w-[86.25rem] border-[1px] border-solid border-[#4848A4] rounded-xl'>
        <div className='text-6xl font-bold text-[#4848A4]'>Lịch sử</div>
        <div className='flex flex-row pl-10 space-x-24 text-[32px]'>
          <div className='text-[64px] font-bold text-[#3896D6]'>2023</div>
